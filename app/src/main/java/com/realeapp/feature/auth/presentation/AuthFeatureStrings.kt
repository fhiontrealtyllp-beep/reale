...
internal object AuthStrings {
    const val WELCOME_TITLE = "Discover Your Dream Home"
...
internal object AuthDims {
    ...
    val WELCOME_TITLE_FONT_SIZE = 36.sp
    val WELCOME_TITLE_LINE_HEIGHT = 40.sp
    val WELCOME_LOGO_FONT_SIZE = 28.sp
    val WELCOME_LOGO_TOP_PADDING = 24.dp
    ...
    val WELCOME_OPTION_HEIGHT = 56.dp
