...
internal object SearchDims {
    ...
    val FILTER_TOGGLE_ROW_HEIGHT = 48.dp
    val FILTER_TOGGLE_INNER_PADDING = 4.dp
    val FILTER_TOGGLE_FONT_SIZE = 14.sp
    val FILTER_TOGGLE_ICON_SIZE = 18.dp
    val FILTER_TOGGLE_ICON_TEXT_SPACING = 8.dp
