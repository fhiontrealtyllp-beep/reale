...
internal object ProfileStrings {
    ...
    const val PROPERTY_DRAFT = "Property Draft"
    const val PROPERTY_DRAFT_SUBTITLE = "Continue your unfinished listing"
    const val CD_PROPERTY_DRAFT = "Resume property draft"
    ...
    const val EMAIL_SUBJECT = "Fhiont - Support Request"
    const val EMAIL_BODY = "Hi Team,\n\nI am writing to you regarding the Fhiont.\n\n"
