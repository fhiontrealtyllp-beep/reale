...
internal object SearchDims {
    ...
    val FILTER_SELECTOR_ELEVATION = 4.dp
...
internal object DetailDims {
    ...
    val HIGHLIGHT_CHIP_CORNER_RADIUS = 8.dp
    val HIGHLIGHT_CHIP_HORIZONTAL_PADDING = 10.dp
    val HIGHLIGHT_CHIP_VERTICAL_PADDING = 6.dp
    val HIGHLIGHT_CHIP_ICON_SIZE = 14.dp
