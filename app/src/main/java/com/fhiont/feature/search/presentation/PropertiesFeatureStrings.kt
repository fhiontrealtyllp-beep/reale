...
internal object PropertiesDims {
    ...
    val CARD_IMAGE_DOT_SIZE = 4.dp
    val CARD_IMAGE_DOT_SPACING = 3.dp
    val CARD_IMAGE_DOTS_HORIZONTAL_PADDING = 5.dp
    val CARD_IMAGE_DOTS_VERTICAL_PADDING = 2.dp
    val CARD_IMAGE_DOTS_CORNER_RADIUS = 4.dp
    val CARD_IMAGE_DOTS_BOTTOM_PADDING = 5.dp
    const val CARD_IMAGE_DOT_ACTIVE_ALPHA = 1f
    const val CARD_IMAGE_DOT_INACTIVE_ALPHA = 0.4f
